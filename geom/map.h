...
class GEOM_API Map : public Object
{
public:
...
private:
	...
	TexVertexAttributeManager	tex_vertex_attribute_manager_ ;
...
protected:
	...
	TexVertex* new_tex_vertex(const TexVertex* rhs) { return target_->new_tex_vertex(rhs) ; }
	...
	void delete_tex_vertex(TexVertex* tv)	{ target_->delete_tex_vertex(tv) ; }
	...
	void set_halfedge_tex_vertex(Halfedge* h, TexVertex* t) {h->set_tex_vertex(t) ;}
...
*/
template<> 
class GEOM_API MapCombelObserver<Map::Vertex> {
public:
...
*/
template<> 
class GEOM_API MapCombelObserver<Map::Halfedge> {
public:
	MapCombelObserver(Map* m) ;
	virtual ~MapCombelObserver() ;
...
*/
template<> 
class GEOM_API MapCombelObserver<Map::Facet> {
public:
	MapCombelObserver(Map* m) ;
	virtual ~MapCombelObserver() ;
