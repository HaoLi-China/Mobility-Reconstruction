...
QT_MOC_LITERAL(1, 12, 9), // "fitScreen"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "PaintCanvas\0fitScreen\0"
};
...
void PaintCanvas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        PaintCanvas *_t = static_cast<PaintCanvas *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->fitScreen(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
void *PaintCanvas::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Canvas"))
        return static_cast< Canvas*>(const_cast< PaintCanvas*>(this));
